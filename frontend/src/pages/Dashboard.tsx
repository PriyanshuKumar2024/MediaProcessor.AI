    ...
    <div className="flex min-h-screen flex-col bg-slate-50">
      ...
      <main className="flex-grow mx-auto w-full max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-y-4">
          <div>
            <h1 className="text-2xl font-bold tracking-tight text-slate-900">Jobs Dashboard</h1>
                    ...
                    <div className="flex flex-1 flex-col p-5">
                      ...
                      {isFailed && (
                        <div className="mt-4 pt-3 border-t border-slate-100">
                          <button
                            onClick={(e) => {
                              e.stopPropagation(); // Avoid triggering parent modal
                              retryMutation.mutate(job.id);
                            }}
                            disabled={retryMutation.isPending}
                            className="inline-flex w-full items-center justify-center rounded-lg border border-slate-200 bg-white px-3 py-1.5 text-xs font-semibold text-slate-700 hover:bg-slate-50 hover:text-slate-900 transition disabled:opacity-50"
                          >
                ...
                <div className={`p-4 rounded-xl border ${
                  ...
                  {selectedJob.flagged ? (
                    <div className="space-y-1">
                      <p className="text-sm font-bold text-amber-950 flex items-center space-x-1.5">
                        ...
                        <span>Content Warning: Flagged</span>
                      </p>
                      <p className="text-xs">
                    ...
                    <p className="text-sm font-medium text-slate-700 flex items-center space-x-1.5">
